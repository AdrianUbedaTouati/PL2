...
static const yytype_int16 yyrline[] =
{
     ...
     497,   502,   556,   563,   578,   584,   589,   595,   611,   611
};
#endif
...
#line 220 "plp5.y"
                                                            {
                                                             if ((ttipos->tipos)[yyvsp[-2].tipo].clase == ARRAY) {
                                                                ...
                                                                string stemp = to_string(nuevaTemporal(yyvsp[-2].lexema,yyvsp[-2].nlin,yyvsp[-2].ncol));
