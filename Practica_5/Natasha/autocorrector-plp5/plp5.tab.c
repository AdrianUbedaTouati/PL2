...
{
       0,    81,    81,    84,    85,    88,    91,    94,    95,    98,
      99,   102,   103,   104,   105,   108,   109,   112,   113,   114,
     115,   116,   117,   118,   119,   122,   123,   126,   127,   130,
     131,   134,   135,   136,   139,   140,   143,   144,   145,   146,
     147,   148,   149,   152,   168,   168
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DVar", "MDVar", "LId", "Tipo", "SInstr", "Instr", "Expr", "Econj",
  "Ecomp", "Esimple", "Term", "Factor", "Ref", "$@1", YY_NULLPTR
};
#endif
...
{
      22,   -17,    37,    14,   -54,    36,    74,    54,   -54,   -54,
     -54,   -54,    19,    74,    18,    29,    24,    29,    29,    54,
      36,   -54,     1,   -54,   -21,    39,    74,    53,    40,   -54,
     -54,   -54,   -54,    29,    -3,    -3,    21,    23,   -54,    10,
      41,   -54,    27,    27,    -4,   -11,    52,    54,   -54,    54,
      29,   -54,    74,   -54,   -54,    46,   -13,    41,   -54,    29,
      29,    29,    -3,    -3,    54,    54,    29,     4,   -54,    21,
      29,   -54,    60,    48,   -54,    23,   -54,    44,    41,   -54,
      70,   -54,    21,   -54,   -24,    46,   -54,    54,   -54,   -54,
     -54
};
...
static const yytype_int8 yydefact[] =
{
      ...
      12,    13,     0,     8,     0,     0,     0,     0,     0,     0,
       4,    43,     0,    16,     0,     0,     8,     0,     0,    41,
      42,    37,    38,     0,     0,     0,    17,    26,    28,    30,
      32,    35,    36,    18,     0,     0,     0,     0,     2,     0,
       0,    44,     0,     7,     5,    10,     0,    33,    40,     0,
       0,     0,     0,     0,     0,     0,     0,     0,    15,    23,
       0,    14,     0,     0,    39,    25,    27,    29,    31,    34,
      19,    21,    22,    24,     0,    10,     6,     0,    45,     9,
      20
};
...
{
     -54,   -54,    67,   -54,    82,    63,     5,    42,    45,   -18,
     -15,    32,    33,   -53,   -30,   -29,    -7,   -54
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     7,     8,    26,    27,    73,    14,    22,    23,
      36,    37,    38,    39,    40,    41,    42,    70
};
...
{
      24,    46,    44,    45,    57,    48,    58,    65,    77,    43,
      62,    64,    24,     3,    88,    50,    51,    84,    56,    74,
      29,    30,    21,    31,    32,     1,    83,    59,    33,    59,
      49,    68,    78,    49,    79,    69,    59,     4,    35,     5,
      24,     6,    24,    61,    62,    25,    80,    81,    28,    21,
      52,    82,    29,    30,    21,    31,    32,    24,    24,    54,
      33,    59,    60,    34,    51,    55,    15,    16,    17,    90,
      35,    18,    66,    19,    72,    20,    63,    86,    62,    21,
      24,     9,    10,    11,    12,    85,    87,    47,    13,    53,
      89,    75,    67,    76,    71
};

static const yytype_int8 yycheck[] =
{
       7,    19,    17,    18,    34,     4,    35,    18,    61,    16,
      34,    15,    19,    30,    38,    36,    37,    70,    33,    32,
      23,    24,    25,    26,    27,     3,    22,    40,    31,    40,
      29,    49,    62,    29,    63,    50,    40,     0,    41,    25,
      47,     5,    49,    33,    34,    26,    64,    65,    30,    25,
      11,    66,    23,    24,    25,    26,    27,    64,    65,     6,
      31,    40,    39,    34,    37,    25,    12,    13,    14,    87,
      41,    17,    20,    19,    28,    21,    35,    29,    34,    25,
      87,     7,     8,     9,    10,    25,    16,    20,     6,    26,
      85,    59,    47,    60,    52
};
...
static const yytype_int8 yystos[] =
{
       ...
       8,     9,    10,    46,    49,    12,    13,    14,    17,    19,
      21,    25,    50,    51,    58,    26,    46,    47,    30,    23,
      24,    26,    27,    31,    34,    41,    52,    53,    54,    55,
      56,    57,    58,    58,    52,    52,    51,    44,     4,    29,
      36,    37,    11,    47,     6,    25,    52,    56,    57,    40,
      39,    33,    34,    35,    15,    18,    20,    50,    51,    52,
      59,    49,    28,    48,    32,    53,    54,    55,    56,    57,
      51,    51,    52,    22,    55,    25,    29,    16,    38,    48,
      51
};
...
#line 152 "plp5.y"
                              ...
                              if ((ctemp = nuevaTemp()) == -1) {
                                 errorSemantico(ERR_MAXTMP, yyvsp[0].nlin, yyvsp[0].ncol, yyvsp[0].lexema);
                              }
                              yyval.dir = ctemp;
...
#line 1459 "plp5.tab.c"
  ...
  case 44:
#line 168 "plp5.y"
                              {  // si Ref no es un array, no puede tener [
